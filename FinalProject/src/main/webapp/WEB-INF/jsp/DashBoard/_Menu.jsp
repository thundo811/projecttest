  <div class="col-md-3 left_col">
        ...
        <div class="profile_info">
            ...
            <div class="navbar nav_title"  >
              <a href="index.html" class="site_title"  > <span style="color:black;margin-left:20px">INVOICES G9</span></a>
            </div>
            ...
            <div class="profile clearfix" >
              <div class="profile_pic">
                <img src="${pageContext.request.contextPath}/resources/production/images/img.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Profile User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath}/dashboard/showProfile">Update Info </a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath}/dashboard/invoices/report">Report</a></li>
                    </ul>
                  </li>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a style="font-weight: bold;color :#73879C " href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
